...
const (
	LaptopService_RateLaptop_FullMethodName   = "/pb.v1.LaptopService/RateLaptop"
	LaptopService_UploadImage_FullMethodName  = "/pb.v1.LaptopService/UploadImage"
	LaptopService_CreateLaptop_FullMethodName = "/pb.v1.LaptopService/CreateLaptop"
	LaptopService_SearchLaptop_FullMethodName = "/pb.v1.LaptopService/SearchLaptop"
)
...
type LaptopServiceClient interface {
	RateLaptop(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[RateLaptopRequest, RateLaptopResponse], error)
...
func (c *laptopServiceClient) RateLaptop(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[RateLaptopRequest, RateLaptopResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &LaptopService_ServiceDesc.Streams[0], LaptopService_RateLaptop_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
type LaptopService_RateLaptopClient = grpc.ClientStreamingClient[RateLaptopRequest, RateLaptopResponse]
...
func (c *laptopServiceClient) SearchLaptop(ctx context.Context, in *SearchLaptopRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[SearchLaptopResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &LaptopService_ServiceDesc.Streams[2], LaptopService_SearchLaptop_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
type LaptopServiceServer interface {
	RateLaptop(grpc.ClientStreamingServer[RateLaptopRequest, RateLaptopResponse]) error
...
func (UnimplementedLaptopServiceServer) RateLaptop(grpc.ClientStreamingServer[RateLaptopRequest, RateLaptopResponse]) error {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type LaptopService_RateLaptopServer = grpc.ClientStreamingServer[RateLaptopRequest, RateLaptopResponse]
...
var LaptopService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pb.v1.LaptopService",
	...
	Metadata: "pb/v1/laptop_service.proto",
}
